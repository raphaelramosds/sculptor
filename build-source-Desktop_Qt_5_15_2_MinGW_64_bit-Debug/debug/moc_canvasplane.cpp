...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CanvasPlane_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CanvasPlane_t qt_meta_stringdata_CanvasPlane = {
    {
QT_MOC_LITERAL(0, 0, 11), // "CanvasPlane"
QT_MOC_LITERAL(1, 12, 7), // "posicao"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "CanvasPlane\0posicao\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_CanvasPlane[] = {
...
void CanvasPlane::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CanvasPlane::posicao)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CanvasPlane::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CanvasPlane.data,
...
// SIGNAL 0
void CanvasPlane::posicao(int _t1, int _t2)
{
